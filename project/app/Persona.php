...
{
    protected $fillable = ['cedula_persona', 'nombre1', 'nombre2', 'apellido1', 'apellido2', 'fecha_nacimiento', 'nacionalidad', 'telefono', 'direccion', 'estatura', 'peso', 'tipo_sangre', 'tipo', 'email', 'cedula_frente', 'cedula_atras', 'boleta_inscripcion'];
