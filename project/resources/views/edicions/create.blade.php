            ...
            <div class="col-md-12">
                 <form action="{{ route('edicions.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-xs-4">
                    	    ...
                    	    <input class=" form-control" type="text" name="lugar" id="lugar-field" value="" placeholder="Digite el lugar de la edición" />
                        </div> 
                    </div>
                <div class="row">
                    ...
                    <div class="row">
                    	...
                    	<label for="fecha_inicio-field">Fecha inicial de edición</label>
                    	    <div class="input-group date" data-provide="datepicker">
                                <input type="text" class="form-control" id="fecha_inicio-field" name="fecha_inicio" data-date-format="YYYY-MM-DD">
                ...
                <div class="row">
                    <div class="form-group col-xs-2">
                	    <label for="fecha_fin-field">Fecha final de edición</label>
                    	    <div class="input-group date" data-provide="datepicker">
                                <input type="text" class="form-control" id="fecha_fin-field" name="fecha_fin" data-date-format="YYYY-MM-DD">
                            <div class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar"></span>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="form-group col-xs-2">
                    	...
                    	<div class="input-group date" data-provide="datepicker">
                            <input type="text" class="form-control" id="fecha_inscripcion-field" name="fecha_inscripcion" data-date-format="YYYY-MM-DD">
                            <div class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar"></span>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="form-group col-xs-2">
                    	...
                    	<div class="input-group date" data-provide="datepicker">
                            <input type="text" class="form-control" id="fecha_fin_inscripcion-field" name="fecha_fin_inscripcion" data-date-format="YYYY-MM-DD">
                            <div class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar"></span>
                            </div>
                        </div>
